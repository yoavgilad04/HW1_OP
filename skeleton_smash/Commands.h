...
public:
    ...
    void PrintJobsListEmpty(string cmd) { cerr << this->pre_error << cmd << ": jobs list is empty" << endl; }

    void PrintInvalidArgs(string cmd) { cerr << this->pre_error << cmd << ": invalid arguments" << endl; }

    void PrintInvalidCore(string cmd) { cerr << this->pre_error << cmd << ": invalid core number" << endl; }
    ...
    void PrintTooManyArgs(string cmd) { cerr << this->pre_error << cmd << ": too many arguments" << endl; }

    void PrintOLDPWDFail(string cmd) { cerr << this->pre_error << cmd << ": OLDPWD not set" << endl; }
